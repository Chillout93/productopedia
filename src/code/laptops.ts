...
export const laptops: CategoryDescription = {
    ...
    metrics: [
        { name: "Build Quality", description: "A laptop with better build quality will have more premium materials like metal and carbon fiber over plasic, and generally be put together in a more professsional manner." },
        {
